...
namespace Trpg.Pawns
{
    ...
    public sealed class PawnInfoBarWidget : MonoBehaviour
    {
        ...
        private bool _usesCallOfCthulhuRules = true;
        private bool _resourceConditionEditingEnabled;
        ...
        public event Action<PawnResourceValueData>
            ResourceConditionRequested;
        ...
        public void SetResourceConditionEditingEnabled(bool enabled)
        {
            _resourceConditionEditingEnabled = enabled;
            EnsureResourceBar();
            _resourceBar?.SetConditionEditingEnabled(enabled);
        }
        ...
        public void SetUsesCallOfCthulhuRules(bool enabled)
        {
            _usesCallOfCthulhuRules = enabled;
        }
        ...
        {
            EnsureRollWidget();
            _rollWidget?.PlayModifiedD100(modifiedRoll, data);
        }
        ...
        private void OnDestroy()
        {
            ...
            ResourceConditionRequested = null;
        ...
        private void EnsureRollWidget()
        {
            ...
            {
                _rollWidget?.ConfigureOverlayCanvas(_canvasRect);
                _rollWidget?.SetActionButtonsVisible(
        ...
        private void BindRollWidget()
        {
            ...
            _rollWidget.ResourceRollRequested += HandleResourceRollRequested;
        ...
        private void BindResourceBar()
        {
            ...
            _resourceBar.ValueEditRequested +=
                HandleResourceStatValueEditRequested;
            _resourceBar.RollRequested -=
                HandleResourceRollButtonRequested;
            _resourceBar.RollRequested +=
                HandleResourceRollButtonRequested;
            _resourceBar.ConditionRequested -=
                HandleResourceConditionButtonRequested;
            _resourceBar.ConditionRequested +=
                HandleResourceConditionButtonRequested;
            _resourceBar.SetConditionEditingEnabled(
                _resourceConditionEditingEnabled);
        }
        ...
        private void HandleResourceRollButtonRequested(
            PawnResourceValueData resource)
        {
            EnsureRollWidget();
            _rollWidget?.OpenResourceRoll(
                resource,
                _usesCallOfCthulhuRules);
        }

        private void HandleResourceConditionButtonRequested(
            PawnResourceValueData resource)
        {
            ResourceConditionRequested?.Invoke(resource);
        }
